 ...
 * {@linkplain java.lang.CharSequence
 ...
 * be changed. See {@link #useAnchoringBounds
 ...
 * if a new input sequence is desired, its
...
public final class Matcher implements MatchResult {
	 ...
	 * the beginning of the region; unlike that method, it does not require
	 * that the entire region be matched.
	 * <p>
	 * If the match succeeds then more information can be obtained via the
	 * <tt>start</tt>, <tt>end</tt>, and <tt>group</tt> methods.
	 * </p>
	 ...
	 * an invocation of this method on a matcher for that expression would
	 * yield the string <tt>"-foo-foo-foo-"</tt>.
	 * <p>
	 ...
	 * <tt>"zzzdogzzzdogzzz"</tt>, and the replacement string <tt>"cat"</tt>,
	 * an invocation of this method on a matcher for that expression would
	 * yield the string <tt>"zzzcatzzzdogzzz"</tt>.
	 * </p>
	 * <p>
	 * Invoking this method changes this matcher's state. If the matcher is to
	 * be used in further matching operations then it should first be reset.
	 ...
	 * representation of a <code>Matcher</code> contains information that may
	 * be useful for debugging. The exact format is unspecified.
	 *
	 ...
	 * won't be lost. If a match was not found, then requireEnd has no meaning.
	 *
